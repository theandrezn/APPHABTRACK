...
```text
habit-game:v1:{year}-{month}
```

Changing month or year loads that month from localStorage. If no saved month exists, the app creates a fresh month using the current habit list.
